...
main()
{
    ...
    *p = 5;
    ...
    // double &s = x; not valid - type safety
    ...
    // int &r3; not valid, references must be defined during declaration
    ...
    *pd = 3;
    ...
    cout << dif3 << endl;
    // different areas of mem

    cout << endl << "print array of doubles forward and backward" << endl <<
        endl;
    ...
    hw08::print_2darray_subscript(twoDDoubles, hw08::ARRAY_SIZE,
        hw08::ARRAY_SIZE);
    // print 2ddoubles via pointer arithmetic
    hw08::print_2darray_pointer((double*)twoDDoubles, hw08::ARRAY_SIZE,
        hw08::ARRAY_SIZE);
    ...
    // Q#4 - new, delete operator examples
    {
        ...
        //int ptr assigned to double ptr
        //pd = pi;  // [4.6] pd points to pi
        //type safety - different ptr types
    ...
    p_p_tictactoe[0] = new int[hw08::TIC_TAC_TOE_SIZE]
    {
    1, 0, 0 };
    // ... // [5.2] row2: dynamically allocate int[TIC_TAC_TOE_SIZE], use initializer list to init to {0,1,0}
    p_p_tictactoe[1] = new int[hw08::TIC_TAC_TOE_SIZE]
    {
    0, 1, 0 };
    // ... // [5.3] row3: dynamically allocate int[TIC_TAC_TOE_SIZE], use initializer list to init to {0,0,1}
    p_p_tictactoe[2] = new int[hw08::TIC_TAC_TOE_SIZE]
    {
    0, 0, 1 };

    // print 2dints via subscript operator
    hw08::print_2darray_dynamic_subscript(p_p_tictactoe,
        hw08::TIC_TAC_TOE_SIZE,
        hw08::TIC_TAC_TOE_SIZE);
    // print 2dints via pointer arithmetic
    hw08::print_2darray_dynamic_pointer(p_p_tictactoe, hw08::TIC_TAC_TOE_SIZE,
        hw08::TIC_TAC_TOE_SIZE);
...
// [1.9] var s refers to x
// double &s = x; type safety - not valid

// [1.15] var r3, ref to int not init.
// int &r3; must be defined
...
// different mem locations on heap

// [2.9] // ... error explain (dif3)
// diff mem locations on stack

// [4.5] pi points to pd ... error explain (pi = pd;)
// ptr of type double - type safety

// [4.6] pd points to pi ... error explain (pd = pi;)
// can't assign different types of ptrs
